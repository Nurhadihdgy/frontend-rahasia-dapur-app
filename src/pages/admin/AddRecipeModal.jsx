...
import Input from '../../components/common/Input'; // Menggunakan komponen Input Anda
                  ...
                  {ingredients.map((ing, i) => (
                    <div key={i} className="flex gap-2 items-center">
                      ...
                      {ingredients.length > 1 && (
                        <button type="button" onClick={() => handleRemoveField(i, setIngredients)} className="text-red-300 hover:text-red-500 mt-1">
                          <Trash2 size={20}/>
                        </button>
                      )}
                    </div>
                ...
                <div className="space-y-3">
                  {steps.map((step, i) => (
                    <div key={i} className="flex gap-3 items-start">
                      ...
                      <textarea 
                        className="flex-1 px-4 py-3 bg-white rounded-xl border border-gray-200 transition-all outline-none focus:border-dapur-orange focus:ring-1 focus:ring-dapur-orange h-20 resize-none" 
                        value={step} 
